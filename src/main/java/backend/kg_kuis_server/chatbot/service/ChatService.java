...
public class ChatService {
    ...
    public Answer ask(String question) {
        ...
        var systemPrompt = """
                너는 대학 학사 도우미야. 시간 기준은 반드시 KST를 사용해.
                ...
                ## 필터링 규칙
                (코드에서 미리 필터링되지 않았다면 아래 규칙을 네가 적용해라. 기본 모드는 ACTIVE_OR_UPCOMING이다.)
                ...
                3) 공지(notice)
                  - 시간제약형(마감/접수/행사): pubDate 적용
                    - 기본: pubDate가 오늘 기준, 한달 이내 데이터 적용.
                ...
                - 관련 데이터를 찾지 못하면 정확히 `관련 데이터를 찾을 수 없습니다.` 라고만 답하고, [참고 링크]는 생략.
