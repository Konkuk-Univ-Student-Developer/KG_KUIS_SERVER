...
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('0043', 'BBAA57369', 2021, 'FIRST', 0, '전선', 'C프로그래밍', 3, '미지정', 'N/A', '박소영', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('1284', 'BKSA54991', 2021, 'FIRST', 0, '전선', '진로설계와직업탐색', 3, '미지정', 'N/A', '미배정', '이론', 'P/N평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
...
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3428', 'BBWA12022', 2021, 'SECOND', 0, '전선', '시스템프로그래밍', 3, '미지정', 'N/A', '임민규', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3440', 'BBWA51983', 2021, 'SECOND', 0, '전선', '랜덤프로세스개론', 3, '미지정', 'N/A', '임창훈', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3432', 'BBWA12052', 2021, 'SECOND', 0, '전선', '컴퓨터구조', 3, '미지정', 'N/A', '박소영', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('0040', 'BBAA57358', 2021, 'SECOND', 0, '전선', 'JAVA프로그래밍', 3, '미지정', 'N/A', '지정희', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('2041', 'BBWA57404', 2021, 'SECOND', 0, '전선', '소프트웨어학과세미나', 3, '미지정', 'N/A', '장현국', '이론', 'P/N평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('1260', 'BKSA39798', 2021, 'SECOND', 0, '심교', '비판적사고와토론', 3, '미지정', 'N/A', '김은하', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3446', 'BBWA55616', 2021, 'SECOND', 0, '전선', 'C++프로그래밍', 3, '미지정', 'N/A', '지정희', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3198', 'BBAB12190', 2022, 'FIRST', 0, '전선', '운영체제', 3, '미지정', 'N/A', '김두현', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3228', 'BBAB62244', 2022, 'FIRST', 0, '전선', '전공기초프로젝트1(종합설계)', 3, '미지정', 'N/A', '차리서', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3204', 'BBAB51979', 2022, 'FIRST', 0, '전선', '모바일프로그래밍', 3, '미지정', 'N/A', '지정희', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('0446', 'COAA83619', 2022, 'FIRST', 0, '반교', '확률과통계', 3, '미지정', 'N/A', '이향원', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3189', 'BBAB12042', 2022, 'FIRST', 0, '전선', '자료구조', 3, '미지정', 'N/A', '김성열', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3221', 'BBAB59453', 2022, 'FIRST', 0, '전선', '컴퓨터구조', 3, '미지정', 'N/A', '박능수', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3173', 'BBAB12017', 2022, 'SECOND', 0, '전선', '소프트웨어아키텍처', 3, '미지정', 'N/A', '민덕기', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3209', 'BBAB62243', 2022, 'SECOND', 0, '전선', 'UX디자인', 3, '미지정', 'N/A', '김지인', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3206', 'BBAB61223', 2022, 'SECOND', 0, '전선', 'K-Lab프로젝트2(종합설계)', 3, '미지정', 'N/A', '이희연, 윤경로', '이론',
        '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3196', 'BBAB55842', 2022, 'SECOND', 0, '전선', '산학협력프로젝트2(종합설계)', 3, '미지정', 'N/A', '장현국', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3179', 'BBAB12022', 2022, 'SECOND', 0, '전선', '알고리즘', 3, '미지정', 'N/A', '김성열', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3201', 'BBAB59363', 2022, 'SECOND', 0, '전선', '네트워크프로그래밍', 3, '미지정', 'N/A', '이향원', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('8073', 'BKUA65019', 2022, 'WINTER', 0, '전선', '국제단기프로그램6', 3, '미지정', 'N/A', '미배정', '이론', 'P/N평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('1552', 'BKSA11433', 2023, 'SECOND', 0, '전선', 'TECHNICAL COMMUNICATION', 3, '미지정', 'N/A', '이종연', '이론', '절대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('1590', 'BKSA53751', 2023, 'SECOND', 0, '심교', '클래식음악여행', 3, '미지정', 'N/A', '권동현', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3180', 'BBAB53292', 2023, 'SECOND', 0, '전선', '컴퓨테이션이론', 3, '미지정', 'N/A', '남원홍', '이론', '상대평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3183', 'BBAB55840', 2023, 'SECOND', 0, '전선', '졸업프로젝트1(종합설계)', 3, '미지정', 'N/A', '정갑주', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3205', 'BBAB62247', 2023, 'SECOND', 0, '전선', '전공기초프로젝트2(종합설계)', 3, '미지정', 'N/A', '차리서', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3203', 'BBAB62245', 2023, 'SECOND', 0, '전선', '컴퓨터정보보안', 3, '미지정', 'N/A', '박소영', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('1295', 'BKSA54994', 2024, 'FIRST', 0, '전선', '실전취업특강', 3, '미지정', 'N/A', '미배정', '이론', 'P/N평가');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3206', 'BBAB55841', 2024, 'FIRST', 0, '전선', '졸업프로젝트2(종합설계)', 3, '미지정', 'N/A', '정갑주', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
...
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
VALUES ('3202', 'BBAB55836', 2024, 'FIRST', 0, '전선', '산학협력프로젝트1(종합설계)', 3, '미지정', 'N/A', '김재군', '이론', '절대평가(ABF제)');
INSERT INTO course_entity (course_number, course_code, course_year, semester, grade, course_category, course_name,
                           credit, department_name, schedule, professor, lecture_type, method)
...
VALUES (1, 1, 'B', 50, 72, 80, 49, 0, 0, 0, 0, 0),
       (1, 2, 'B', 10, 15, 16, 0, 0, 30, 0, 0, 0),
       (1, 3, 'A+', 0, 0, 0, 0, 0, 0, 0, 0, 95),
       (1, 4, 'C+', 14, 20, 33, 10, 0, 0, 0, 0, 0),
       (1, 5, 'P', 0, 0, 0, 0, 0, 0, 0, 75, 0),
       (1, 6, 'B+', 20, 0, 0, 42, 22, 0, 0, 0, 0),
       (1, 7, 'B+', 14, 29, 29, 15, 0, 0, 0, 0, 0),
       (1, 8, 'B+', 100, 78, 79, 96, 0, 0, 0, 0, 0),
       (1, 9, 'B+', 0, 40, 45, 100, 0, 0, 0, 0, 0),
       (1, 10, 'A', 95, 100, 74, 18, 0, 0, 0, 28, 10),
       (1, 11, 'C+', 14, 17, 24, 14, 0, 0, 0, 0, 0),
       (1, 12, 'A', 8, 99, 88, 65, 47, 24, 43, 46, 0),
       (1, 13, 'A', 29, 23, 23, 19, 0, 0, 0, 0, 0),
       (1, 14, 'P', 0, 0, 0, 0, 0, 0, 0, 0, 100),
       (1, 15, 'C+', 80, 55, 25, 76, 0, 100, 0, 0, 0),
       (1, 16, 'P', 100, 100, 100, 100, 0, 0, 0, 0, 0),
       (1, 17, 'A', 15, 29, 28, 15, 0, 0, 0, 0, 0),
       (1, 18, 'C+', 20, 58, 46, 10, 0, 0, 0, 0, 0),
       (1, 19, 'B+', 10, 31, 20, 15, 0, 0, 0, 0, 0),
       (1, 20, 'B+', 10, 30, 15, 0, 17, 0, 0, 0, 0),
       (1, 21, 'B+', 10, 13, 14, 20, 0, 0, 0, 0, 0),
       (1, 22, 'C', 20, 36, 32, 46, 0, 0, 0, 0, 6),
       (1, 23, 'C+', 100, 72, 48, 95, 0, 0, 0, 0, 0),
       (1, 24, 'C+', 10, 38, 31, 10, 0, 0, 13, 0, 0),
       (1, 25, 'P', 97, 91, 86, 0, 0, 0, 0, 0, 0),
       (1, 26, 'B+', 4, 23, 20, 10, 14, 0, 0, 0, 0),
       (1, 27, 'C', 9, 30, 5, 7, 0, 0, 17, 0, 0),
       (1, 28, 'A', 10, 0, 37, 28, 0, 0, 0, 0, 0),
       (1, 29, 'A+', 10, 10, 10, 10, 0, 0, 58, 0, 0),
       (1, 30, 'B', 5, 0, 0, 35, 25, 0, 0, 0, 18),
       (1, 31, 'B+', 15, 16, 20, 25, 0, 0, 0, 0, 0),
       (1, 32, 'B+', 100, 0, 47, 100, 0, 0, 0, 0, 0),
       (1, 33, 'C+', 10, 0, 0, 32, 0, 0, 0, 0, 0),
       (1, 34, 'A+', 10, 32, 35, 15, 0, 0, 0, 0, 0),
       (1, 35, 'A+', 10, 24, 30, 30, 0, 0, 0, 0, 0),
       (1, 36, 'A+', 20, 0, 0, 15, 65, 0, 0, 0, 0),
       (1, 37, 'A+', 98, 95, 96, 95, 0, 0, 0, 0, 0),
       (1, 38, 'C', 100, 14, 2, 40, 0, 0, 0, 0, 0),
       (1, 39, 'B+', 10, 12, 30, 17, 0, 0, 0, 0, 0),
       (1, 40, 'P', 100, 100, 100, 100, 0, 0, 0, 0, 0),
       (1, 41, 'A', 14, 0, 35, 20, 96, 2, 2, 1, 0),
       (1, 42, 'B+', 18, 15, 46, 0, 0, 0, 0, 0, 0),
       (1, 43, 'B+', 32, 90, 55, 100, 0, 0, 0, 0, 0),
       (1, 44, 'A', 10, 0, 0, 0, 0, 0, 83, 0, 0),
       (1, 45, 'A+', 10, 10, 10, 10, 0, 0, 58, 0, 0),
       (1, 46, 'B+', 80, 82, 78, 77, 0, 0, 0, 0, 0),
       (1, 47, 'P', 100, 100, 100, 100, 0, 0, 0, 0, 0),
       (1, 48, 'A+', 9, 0, 0, 0, 0, 0, 87, 0, 0),
       (1, 49, 'B+', 100, 93, 96, 96, 0, 0, 0, 0, 0),
       (1, 50, 'A+', 10, 32, 39, 15, 0, 0, 0, 0, 0),
       (1, 51, 'A', 19, 0, 0, 20, 0, 0, 53, 0, 0),
       (1, 52, 'A+', 18, 30, 30, 10, 0, 10, 0, 0, 0);
